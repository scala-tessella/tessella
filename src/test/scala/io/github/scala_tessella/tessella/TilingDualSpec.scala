...
class TilingDualSpec extends AnyFlatSpec with Helper with should.Matchers {
  ...
  "A triangle" can "be converted" in {
    ...
    triangle.toTilingDual2.toString shouldBe
      "TilingDual(1--4, 2--4, 3--4)"
    triangle.toTilingDual2.boundary shouldBe
      Vector(3, 3, 3)
  }
  ...
  "An hexagon made of triangles" can "be converted" in {
    ...
    hexagonTriangles.toTilingDual2.toString shouldBe
      "TilingDual(1--9, 2--10, 3--12, 4--11, 5--7, 6--8, 7--8, 7--11, 8--9, 9--10, 10--12, 11--12)"
    hexagonTriangles.toTilingDual2.boundary shouldBe
      Vector(3, 3, 3, 3, 3, 3)
  }
